...
// Composite Chart
// ================================================================================
let report_count_list = [0.466116, 0.886817];
...
let line_composite_data = {
	...
	datasets: [{
		"values": [14.4, 15.0, 15.1, 16.5, 18.5, 23.0,
	27.9, 35.5, 35.6, 33.9, 36.1, 37.9],
...
let bar_composite_chart = new Chart (c1, {
	title: "Chart of Coefficient of Correlation (Corr)",
...
let line_composite_chart = new Chart (c2, {
	title: "Chart of History of Pork Price", 
